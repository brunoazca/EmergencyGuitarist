...
class AppLibrary {
    ...
    let messages: [GuitarMessage] = [
        GuitarMessage(text: "Place the iPad in front of you and step back a little so your upper body and head fit within the camera frame. Then, press the button!", passMethod: .positionGuitar),
        ...
        GuitarMessage(text: "Let's start with the A chord! Place your index, middle and ring fingers in the indicated positions on the guitar neck! (If hard, get closer to camera)", passMethod: .aChord),
